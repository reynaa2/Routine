;This file lives in the following location
; /Volumes/coveydata/APOGEE_Spectra/APOGEE2_DR13/Bisector/Jessica 
; =====================================================================================
; PURPOSE:
; This routine will find the bisector values of a given CFF from APOGEE.
; =====================================================================================
; Parameters Calculated:
;   1. CCF Width
;   2. CCF Bisector Points (5 total)
;   3. CCF Height
;   4. CCF Threshold
;   5. X-ranges of the bisectors
;   6. Mean of X values of the bisector values (x_man)
;   7. Median of X values of the busector values (x_median)
;   8. Difference in x values from max x value to median x value (Diff_in_x)
;   9. Maximum x-range value found over all visits of a star (XR_Max)
;   10. Minimum R value over all visits of a star (R_min)
;   
;   
;======================================================================================
FUNCTION measure_r, comb, velocity_axis, peak_loc
  ...
  ;find the length of the ccf function
  ...
  ENDIF ELSE PRINT, 'R not calculated correctly!'
